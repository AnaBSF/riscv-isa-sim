...
#undef DISASM_VECTOR_VV_VS
  ...
  DEFINE_UCONF(ss_sta_ld_d_m);
  DEFINE_UCONF(ss_sta_ld_w_m);
  DEFINE_UCONF(ss_sta_ld_h_m);
  DEFINE_UCONF(ss_sta_ld_b_m);
  ...
  DEFINE_UCONF(ss_sta_ld_d_v_2);
  DEFINE_UCONF(ss_sta_ld_w_v_2);
  DEFINE_UCONF(ss_sta_ld_h_v_2);
  DEFINE_UCONF(ss_sta_ld_b_v_2);
  DEFINE_UCONF(ss_sta_ld_d_v_3);
  DEFINE_UCONF(ss_sta_ld_w_v_3);
  DEFINE_UCONF(ss_sta_ld_h_v_3);
  DEFINE_UCONF(ss_sta_ld_b_v_3);
  DEFINE_UCONF(ss_sta_ld_d_v_4);
  DEFINE_UCONF(ss_sta_ld_w_v_4);
  DEFINE_UCONF(ss_sta_ld_h_v_4);
  DEFINE_UCONF(ss_sta_ld_b_v_4);
  DEFINE_UCONF(ss_sta_ld_d_v_5);
  DEFINE_UCONF(ss_sta_ld_w_v_5);
  DEFINE_UCONF(ss_sta_ld_h_v_5);
  DEFINE_UCONF(ss_sta_ld_b_v_5);
  DEFINE_UCONF(ss_sta_ld_d_v_6);
  DEFINE_UCONF(ss_sta_ld_w_v_6);
  DEFINE_UCONF(ss_sta_ld_h_v_6);
  DEFINE_UCONF(ss_sta_ld_b_v_6);
  DEFINE_UCONF(ss_sta_ld_d_v_7);
  DEFINE_UCONF(ss_sta_ld_w_v_7);
  DEFINE_UCONF(ss_sta_ld_h_v_7);
  DEFINE_UCONF(ss_sta_ld_b_v_7);
  DEFINE_UCONF(ss_sta_ld_d_v_1_m);
  DEFINE_UCONF(ss_sta_ld_w_v_1_m);
  DEFINE_UCONF(ss_sta_ld_h_v_1_m);
  DEFINE_UCONF(ss_sta_ld_b_v_1_m);
  DEFINE_UCONF(ss_sta_ld_d_v_2_m);
  DEFINE_UCONF(ss_sta_ld_w_v_2_m);
  DEFINE_UCONF(ss_sta_ld_h_v_2_m);
  DEFINE_UCONF(ss_sta_ld_b_v_2_m);
  DEFINE_UCONF(ss_sta_ld_d_v_3_m);
  DEFINE_UCONF(ss_sta_ld_w_v_3_m);
  DEFINE_UCONF(ss_sta_ld_h_v_3_m);
  DEFINE_UCONF(ss_sta_ld_b_v_3_m);
  DEFINE_UCONF(ss_sta_ld_d_v_4_m);
  DEFINE_UCONF(ss_sta_ld_w_v_4_m);
  DEFINE_UCONF(ss_sta_ld_h_v_4_m);
  DEFINE_UCONF(ss_sta_ld_b_v_4_m);
  DEFINE_UCONF(ss_sta_ld_d_v_5_m);
  DEFINE_UCONF(ss_sta_ld_w_v_5_m);
  DEFINE_UCONF(ss_sta_ld_h_v_5_m);
  DEFINE_UCONF(ss_sta_ld_b_v_5_m);
  DEFINE_UCONF(ss_sta_ld_d_v_6_m);
  DEFINE_UCONF(ss_sta_ld_w_v_6_m);
  DEFINE_UCONF(ss_sta_ld_h_v_6_m);
  DEFINE_UCONF(ss_sta_ld_b_v_6_m);
  DEFINE_UCONF(ss_sta_ld_d_v_7_m);
  DEFINE_UCONF(ss_sta_ld_w_v_7_m);
  DEFINE_UCONF(ss_sta_ld_h_v_7_m);
  DEFINE_UCONF(ss_sta_ld_b_v_7_m);
  ...
  DEFINE_UCONF(ss_sta_st_d_v_2);
  DEFINE_UCONF(ss_sta_st_w_v_2);
  DEFINE_UCONF(ss_sta_st_h_v_2);
  DEFINE_UCONF(ss_sta_st_b_v_2);
  DEFINE_UCONF(ss_sta_st_d_v_3);
  DEFINE_UCONF(ss_sta_st_w_v_3);
  DEFINE_UCONF(ss_sta_st_h_v_3);
  DEFINE_UCONF(ss_sta_st_b_v_3);
  DEFINE_UCONF(ss_sta_st_d_v_4);
  DEFINE_UCONF(ss_sta_st_w_v_4);
  DEFINE_UCONF(ss_sta_st_h_v_4);
  DEFINE_UCONF(ss_sta_st_b_v_4);
  DEFINE_UCONF(ss_sta_st_d_v_5);
  DEFINE_UCONF(ss_sta_st_w_v_5);
  DEFINE_UCONF(ss_sta_st_h_v_5);
  DEFINE_UCONF(ss_sta_st_b_v_5);
  DEFINE_UCONF(ss_sta_st_d_v_6);
  DEFINE_UCONF(ss_sta_st_w_v_6);
  DEFINE_UCONF(ss_sta_st_h_v_6);
  DEFINE_UCONF(ss_sta_st_b_v_6);
  DEFINE_UCONF(ss_sta_st_d_v_7);
  DEFINE_UCONF(ss_sta_st_w_v_7);
  DEFINE_UCONF(ss_sta_st_h_v_7);
  DEFINE_UCONF(ss_sta_st_b_v_7);
  DEFINE_UCONF(ss_app);
  DEFINE_UCONF(ss_end);
  DEFINE_UMOD(ss_app_sgi_ofs_add);
  DEFINE_UMOD(ss_app_sgi_ofs_dec);
  DEFINE_UMOD(ss_app_sgi_ofs_inc);
  DEFINE_UMOD(ss_app_sgi_ofs_set);
  DEFINE_UMOD(ss_app_sgi_ofs_sub);
  DEFINE_UMOD(ss_app_ind_ofs_add_1);
	DEFINE_UMOD(ss_app_ind_ofs_dec_1);
	DEFINE_UMOD(ss_app_ind_ofs_inc_1);
	DEFINE_UMOD(ss_app_ind_ofs_set_1);
	DEFINE_UMOD(ss_app_ind_ofs_sub_1);
	DEFINE_UMOD(ss_app_ind_siz_add_1);
	DEFINE_UMOD(ss_app_ind_siz_dec_1);
	DEFINE_UMOD(ss_app_ind_siz_inc_1);
	DEFINE_UMOD(ss_app_ind_siz_set_1);
	DEFINE_UMOD(ss_app_ind_siz_sub_1);
	DEFINE_UMOD(ss_app_ind_str_add_1);
	DEFINE_UMOD(ss_app_ind_str_dec_1);
	DEFINE_UMOD(ss_app_ind_str_inc_1);
	DEFINE_UMOD(ss_app_ind_str_set_1);
	DEFINE_UMOD(ss_app_ind_str_sub_1);
	DEFINE_UMOD(ss_app_ind_siz_add_2);
	DEFINE_UMOD(ss_app_ind_siz_dec_2);
	DEFINE_UMOD(ss_app_ind_siz_inc_2);
	DEFINE_UMOD(ss_app_ind_siz_set_2);
	DEFINE_UMOD(ss_app_ind_siz_sub_2);
	DEFINE_UMOD(ss_app_ind_str_add_2);
	DEFINE_UMOD(ss_app_ind_str_dec_2);
	DEFINE_UMOD(ss_app_ind_str_inc_2);
	DEFINE_UMOD(ss_app_ind_str_set_2);
	DEFINE_UMOD(ss_app_ind_str_sub_2);
	DEFINE_UMOD(ss_app_ind_ofs_add_2);
	DEFINE_UMOD(ss_app_ind_ofs_dec_2);
	DEFINE_UMOD(ss_app_ind_ofs_inc_2);
	DEFINE_UMOD(ss_app_ind_ofs_set_2);
	DEFINE_UMOD(ss_app_ind_ofs_sub_2);
	DEFINE_UMOD(ss_app_ind_siz_add_3);
	DEFINE_UMOD(ss_app_ind_siz_dec_3);
	DEFINE_UMOD(ss_app_ind_siz_inc_3);
	DEFINE_UMOD(ss_app_ind_siz_set_3);
	DEFINE_UMOD(ss_app_ind_siz_sub_3);
	DEFINE_UMOD(ss_app_ind_str_add_3);
	DEFINE_UMOD(ss_app_ind_str_dec_3);
	DEFINE_UMOD(ss_app_ind_str_inc_3);
	DEFINE_UMOD(ss_app_ind_str_set_3);
	DEFINE_UMOD(ss_app_ind_str_sub_3);
	DEFINE_UMOD(ss_app_ind_ofs_add_3);
	DEFINE_UMOD(ss_app_ind_ofs_dec_3);
	DEFINE_UMOD(ss_app_ind_ofs_inc_3);
	DEFINE_UMOD(ss_app_ind_ofs_set_3);
	DEFINE_UMOD(ss_app_ind_ofs_sub_3);
	DEFINE_UMOD(ss_app_ind_siz_add_4);
	DEFINE_UMOD(ss_app_ind_siz_dec_4);
	DEFINE_UMOD(ss_app_ind_siz_inc_4);
	DEFINE_UMOD(ss_app_ind_siz_set_4);
	DEFINE_UMOD(ss_app_ind_siz_sub_4);
	DEFINE_UMOD(ss_app_ind_str_add_4);
	DEFINE_UMOD(ss_app_ind_str_dec_4);
	DEFINE_UMOD(ss_app_ind_str_inc_4);
	DEFINE_UMOD(ss_app_ind_str_set_4);
	DEFINE_UMOD(ss_app_ind_str_sub_4);
	DEFINE_UMOD(ss_app_ind_ofs_add_4);
	DEFINE_UMOD(ss_app_ind_ofs_dec_4);
	DEFINE_UMOD(ss_app_ind_ofs_inc_4);
	DEFINE_UMOD(ss_app_ind_ofs_set_4);
	DEFINE_UMOD(ss_app_ind_ofs_sub_4);
	DEFINE_UMOD(ss_app_ind_siz_add_5);
	DEFINE_UMOD(ss_app_ind_siz_dec_5);
	DEFINE_UMOD(ss_app_ind_siz_inc_5);
	DEFINE_UMOD(ss_app_ind_siz_set_5);
	DEFINE_UMOD(ss_app_ind_siz_sub_5);
	DEFINE_UMOD(ss_app_ind_str_add_5);
	DEFINE_UMOD(ss_app_ind_str_dec_5);
	DEFINE_UMOD(ss_app_ind_str_inc_5);
	DEFINE_UMOD(ss_app_ind_str_set_5);
	DEFINE_UMOD(ss_app_ind_str_sub_5);
	DEFINE_UMOD(ss_app_ind_ofs_add_5);
	DEFINE_UMOD(ss_app_ind_ofs_dec_5);
	DEFINE_UMOD(ss_app_ind_ofs_inc_5);
	DEFINE_UMOD(ss_app_ind_ofs_set_5);
	DEFINE_UMOD(ss_app_ind_ofs_sub_5);
	DEFINE_UMOD(ss_app_ind_siz_add_6);
	DEFINE_UMOD(ss_app_ind_siz_dec_6);
	DEFINE_UMOD(ss_app_ind_siz_inc_6);
	DEFINE_UMOD(ss_app_ind_siz_set_6);
	DEFINE_UMOD(ss_app_ind_siz_sub_6);
	DEFINE_UMOD(ss_app_ind_str_add_6);
	DEFINE_UMOD(ss_app_ind_str_dec_6);
	DEFINE_UMOD(ss_app_ind_str_inc_6);
	DEFINE_UMOD(ss_app_ind_str_set_6);
	DEFINE_UMOD(ss_app_ind_str_sub_6);
	DEFINE_UMOD(ss_app_ind_ofs_add_6);
	DEFINE_UMOD(ss_app_ind_ofs_dec_6);
	DEFINE_UMOD(ss_app_ind_ofs_inc_6);
	DEFINE_UMOD(ss_app_ind_ofs_set_6);
	DEFINE_UMOD(ss_app_ind_ofs_sub_6);
	DEFINE_UMOD(ss_app_ind_siz_add_7);
	DEFINE_UMOD(ss_app_ind_siz_dec_7);
	DEFINE_UMOD(ss_app_ind_siz_inc_7);
	DEFINE_UMOD(ss_app_ind_siz_set_7);
	DEFINE_UMOD(ss_app_ind_siz_sub_7);
	DEFINE_UMOD(ss_app_ind_str_add_7);
	DEFINE_UMOD(ss_app_ind_str_dec_7);
	DEFINE_UMOD(ss_app_ind_str_inc_7);
	DEFINE_UMOD(ss_app_ind_str_set_7);
	DEFINE_UMOD(ss_app_ind_str_sub_7);
	DEFINE_UMOD(ss_app_ind_ofs_add_7);
	DEFINE_UMOD(ss_app_ind_ofs_dec_7);
	DEFINE_UMOD(ss_app_ind_ofs_inc_7);
	DEFINE_UMOD(ss_app_ind_ofs_set_7);
	DEFINE_UMOD(ss_app_ind_ofs_sub_7);
	DEFINE_UMOD(ss_app_ind_siz_add_l);
	DEFINE_UMOD(ss_app_ind_siz_dec_l);
	DEFINE_UMOD(ss_app_ind_siz_inc_l);
	DEFINE_UMOD(ss_app_ind_siz_set_l);
	DEFINE_UMOD(ss_app_ind_siz_sub_l);
	DEFINE_UMOD(ss_app_ind_str_add_l);
	DEFINE_UMOD(ss_app_ind_str_dec_l);
	DEFINE_UMOD(ss_app_ind_str_inc_l);
	DEFINE_UMOD(ss_app_ind_str_set_l);
	DEFINE_UMOD(ss_app_ind_str_sub_l);
	...
	DEFINE_UMOD(ss_app_mod_str_dec_1);
	DEFINE_UMOD(ss_app_mod_str_inc_1);
	DEFINE_UMOD(ss_app_mod_ofs_dec_2);
	DEFINE_UMOD(ss_app_mod_ofs_inc_2);
	DEFINE_UMOD(ss_app_mod_siz_dec_2);
	DEFINE_UMOD(ss_app_mod_siz_inc_2);
	DEFINE_UMOD(ss_app_mod_str_dec_2);
	DEFINE_UMOD(ss_app_mod_str_inc_2);
	DEFINE_UMOD(ss_app_mod_ofs_dec_3);
	DEFINE_UMOD(ss_app_mod_ofs_inc_3);
	DEFINE_UMOD(ss_app_mod_siz_dec_3);
	DEFINE_UMOD(ss_app_mod_siz_inc_3);
	DEFINE_UMOD(ss_app_mod_str_dec_3);
	DEFINE_UMOD(ss_app_mod_str_inc_3);
	DEFINE_UMOD(ss_app_mod_ofs_dec_4);
	DEFINE_UMOD(ss_app_mod_ofs_inc_4);
	DEFINE_UMOD(ss_app_mod_siz_dec_4);
	DEFINE_UMOD(ss_app_mod_siz_inc_4);
	DEFINE_UMOD(ss_app_mod_str_dec_4);
	DEFINE_UMOD(ss_app_mod_str_inc_4);
	DEFINE_UMOD(ss_app_mod_ofs_dec_5);
	DEFINE_UMOD(ss_app_mod_ofs_inc_5);
	DEFINE_UMOD(ss_app_mod_siz_dec_5);
	DEFINE_UMOD(ss_app_mod_siz_inc_5);
	DEFINE_UMOD(ss_app_mod_str_dec_5);
	DEFINE_UMOD(ss_app_mod_str_inc_5);
	DEFINE_UMOD(ss_app_mod_ofs_dec_6);
	DEFINE_UMOD(ss_app_mod_ofs_inc_6);
	DEFINE_UMOD(ss_app_mod_siz_dec_6);
	DEFINE_UMOD(ss_app_mod_siz_inc_6);
	DEFINE_UMOD(ss_app_mod_str_dec_6);
	DEFINE_UMOD(ss_app_mod_str_inc_6);
	DEFINE_UMOD(ss_app_mod_ofs_dec_7);
	DEFINE_UMOD(ss_app_mod_ofs_inc_7);
	DEFINE_UMOD(ss_app_mod_siz_dec_7);
	DEFINE_UMOD(ss_app_mod_siz_inc_7);
	DEFINE_UMOD(ss_app_mod_str_dec_7);
	DEFINE_UMOD(ss_app_mod_str_inc_7);
	DEFINE_UMOD(ss_app_mod_ofs_dec_l);
	DEFINE_UMOD(ss_app_mod_ofs_inc_l);
	DEFINE_UMOD(ss_app_mod_siz_dec_l);
	DEFINE_UMOD(ss_app_mod_siz_inc_l);
	DEFINE_UMOD(ss_app_mod_str_dec_l);
	DEFINE_UMOD(ss_app_mod_str_inc_l);
	DEFINE_UMOD(ss_end_sgi_ofs_add);
	DEFINE_UMOD(ss_end_sgi_ofs_dec);
	DEFINE_UMOD(ss_end_sgi_ofs_inc);
	DEFINE_UMOD(ss_end_sgi_ofs_set);
	DEFINE_UMOD(ss_end_sgi_ofs_sub);
  ...
  DEFINE_UBTYPE(so_b_ndc_8);

  DEFINE_UVTYPE_DP(so_v_cv_us_b);
	DEFINE_UVTYPE_DP(so_v_cv_us_h);
	DEFINE_UVTYPE_DP(so_v_cv_us_w);
	DEFINE_UVTYPE_DP(so_v_cv_us_d);
	DEFINE_UVTYPE_DP(so_v_cv_sg_b);
	DEFINE_UVTYPE_DP(so_v_cv_sg_h);
	DEFINE_UVTYPE_DP(so_v_cv_sg_w);
	DEFINE_UVTYPE_DP(so_v_cv_sg_d);
	DEFINE_UVTYPE_DP(so_v_cv_fp_w);
	DEFINE_UVTYPE_DP(so_v_cv_fp_d);
  ...
  DEFINE_UA1TYPE(so_a_sqrt_fp);
  DEFINE_UA1TYPE(so_a_sqrt_us);
  DEFINE_UA1TYPE(so_a_sqrt_sg);
  ...
  DEFINE_UPRED(so_p_not_z);
  DEFINE_UPRED(so_p_mv);
  DEFINE_UPRED(so_p_mv_z);
  DEFINE_UPRED(so_p_mvt);
  DEFINE_UPRED(so_p_mvt_z);
  DEFINE_UPRED_COMP(so_p_eq_fp);
  DEFINE_UPRED_COMP(so_p_ge_fp);
  DEFINE_UPRED_COMP(so_p_lt_fp);
  DEFINE_UPRED_COMP(so_p_eq_fp_z);
  DEFINE_UPRED_COMP(so_p_ge_fp_z);
  DEFINE_UPRED_COMP(so_p_lt_fp_z);
  DEFINE_UPRED_COMP(so_p_eq_sg);
  DEFINE_UPRED_COMP(so_p_ge_sg);
  DEFINE_UPRED_COMP(so_p_lt_sg);
  DEFINE_UPRED_COMP(so_p_eq_sg_z);
  DEFINE_UPRED_COMP(so_p_ge_sg_z);
  DEFINE_UPRED_COMP(so_p_lt_sg_z);
  DEFINE_UPRED_COMP(so_p_eq_us);
  DEFINE_UPRED_COMP(so_p_ge_us);
  DEFINE_UPRED_COMP(so_p_lt_us);
  DEFINE_UPRED_COMP(so_p_eq_us_z);
  DEFINE_UPRED_COMP(so_p_ge_us_z);
  DEFINE_UPRED_COMP(so_p_lt_us_z);
  DISASM_INSN("so.p.zero", so_p_zero, 0, {&up_rd});
  DISASM_INSN("so.p.zero.z", so_p_zero, 0, {&up_rd});
  DISASM_INSN("so.p.one", so_p_one, 0, {&up_rd});
  DISASM_INSN("so.p.one.z", so_p_one, 0, {&up_rd});
  DEFINE_UPRED(so_p_cv_b_h);
	DEFINE_UPRED(so_p_cv_b_w);
	DEFINE_UPRED(so_p_cv_b_d);
	DEFINE_UPRED(so_p_cv_w_b);
	DEFINE_UPRED(so_p_cv_w_d);
	DEFINE_UPRED(so_p_cv_w_h);
	DEFINE_UPRED(so_p_cv_h_b);
	DEFINE_UPRED(so_p_cv_h_w);
	DEFINE_UPRED(so_p_cv_h_d);
	DEFINE_UPRED(so_p_cv_d_b);
	DEFINE_UPRED(so_p_cv_d_h);
	DEFINE_UPRED(so_p_cv_d_w);
	DEFINE_UPRED(so_p_cv_b_h_z);
	DEFINE_UPRED(so_p_cv_b_w_z);
	DEFINE_UPRED(so_p_cv_b_d_z);
	DEFINE_UPRED(so_p_cv_w_b_z);
	DEFINE_UPRED(so_p_cv_w_h_z);
	DEFINE_UPRED(so_p_cv_w_d_z);
	DEFINE_UPRED(so_p_cv_h_b_z);
	DEFINE_UPRED(so_p_cv_h_w_z);
	DEFINE_UPRED(so_p_cv_h_d_z);
	DEFINE_UPRED(so_p_cv_d_b_z);
	DEFINE_UPRED(so_p_cv_d_h_z);
	DEFINE_UPRED(so_p_cv_d_w_z);
}

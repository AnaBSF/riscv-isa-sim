...
std::visit(overloaded{
    [&](StreamReg8 &dest, StreamReg8 &src) { baseBehaviour(dest, src, (unsigned char){}); },
    [&](StreamReg8 &dest, StreamReg16 &src) { baseBehaviour(dest, src, (unsigned short int){}); },
    [&](StreamReg8 &dest, StreamReg32 &src) { baseBehaviour(dest, src, (unsigned int){}); },
    [&](StreamReg8 &dest, StreamReg64 &src) { baseBehaviour(dest, src, (unsigned long int){}); },
    [&](auto &dest, auto &src) { assert_msg("Invoking so.v.cv.us.b with invalid parameter sizes", false); }
}, destReg, srcReg);